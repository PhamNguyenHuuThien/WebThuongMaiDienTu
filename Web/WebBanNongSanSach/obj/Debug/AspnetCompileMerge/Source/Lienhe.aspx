<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeFile="Lienhe.aspx.cs" Inherits="WebBanNongSanSach.Lienhe" %>
        ...
        <div class="">
            ...
            <div id="showText">
                <div class="showText">
                    ...
                    <p>Địa chỉ: Số 1011/4 Lê Hồng Phong, P. Phú Thọ, TP.TDM, Bình Dương</p>
                    <p>Điện thoại:&nbsp;<a href="tel:+84 164671 4040">+84 164 671 4040</a></p>
                    <p>Email:&nbsp;<a href="mailto:admin@demobanhkeo1.vn" target="_blank">admin@webnongnghiep.web30s.vn</a></p>
                </div>
                <div class="contact">
                    <form name="FormNameContact" action="contact/" method="post" class="formBox" id="FormNameContact">
                        <input type="hidden" name="module" value="form">
                        <input type="hidden" name="action" value="goilienhe">
                        <div class="left">
                            <li class="name">
                                <input name="tendaydu" id="tendaydu" type="text" value="" placeholder="Họ tên" onfocus="this.placeholder=''" onblur="this.placeholder='Họ tên'">
                            </li>
                            <li class="phone">
                                <input name="dienthoai" type="tel" value="" minlength="10" maxlength="18" placeholder="Điện thoại" onfocus="this.placeholder=''" onblur="this.placeholder='Điện thoại'">
                            </li>
                            <li class="mail">
                                <input name="email" type="text" value="" placeholder="Email" onfocus="this.placeholder=''" onblur="this.placeholder='Email'">
                            </li>
                            <li class="local">
                                <input name="diachi" type="text" value="" placeholder="Địa chỉ" onfocus="this.placeholder=''" onblur="this.placeholder='Địa chỉ'">
                            </li>
                        </div>
                        <div class="right">
                            <li class="mess">
                                <textarea name="noidung" cols="" rows="" placeholder="Nội dung" onfocus="this.placeholder=''" onblur="this.placeholder='Nội dung'"></textarea>
                            </li>
                            <li class="code">
                                <div class="left">
                                    <input name="mabaove" class="haimabaove" type="text" style="text-transform: uppercase" placeholder="Mã số" onfocus="this.placeholder=''" onblur="this.placeholder='Mã số'">
                                </div>
                                <div class="autoCaptcha imgCaptcha">
                                    <img src="http://webnongnghiep.web30s.vn/imgcode.php?time=0.24682201289267813"><a class="renewCaptcha"><i class="fa fa-refresh" aria-hidden="true"></i></a></div>
                                <div class="clear"></div>
                            </li>
                            <div class="haibuttom">
                                <a onclick="document.getElementById('FormNameContact').reset(); document.getElementById('tendaydu').focus()" style="cursor: pointer" class="button submitbutton">Làm lại</a>
                                <a onclick="if(Check_Form_Name_Contact())document.getElementById('FormNameContact').submit()" style="cursor: pointer" class="button submitbutton">Gởi đi</a>
                                <div class="clear"></div>
                            </div>
                        </div>
                        <div class="clr"></div>
                ...
                <div class="multiple_map">
                    <div></div>
                    <input type="hidden" id="address-0" value="Số 1011/4 Lê Hồng Phong, P. Phú Thọ, TP.TDM, Bình Dương">
                    <input type="hidden" id="latitude-0" value="10.9597939">
                    <input type="hidden" id="longitude-0" value="106.6616416,15">
                    <input type="hidden" id="zoom-0" value="15">
                    <script>
                        $(function () {
                            var PAMapScript = document.createElement('script');
                            PAMapScript.src = '../Scripts/JS/pamap_loader.js?t=18';
                            document.getElementsByTagName('head')[0].appendChild(PAMapScript);
                        });
                    </script>
                    <div class="map_canvas" id="map_canvas-0" style="height: 350px; position: relative; overflow: hidden;" readonly="readonly" data-id-lat="latitude-0" data-id-lng="longitude-0" data-id-addr="address-0" data-id-zoom="zoom-0">
                        <div style="height: 100%; width: 100%; position: absolute; top: 0px; left: 0px; background-color: rgb(229, 227, 223);">
                            <div class="gm-style" style="position: absolute; z-index: 0; left: 0px; top: 0px; height: 100%; width: 100%; padding: 0px; border-width: 0px; margin: 0px;">
                                    ...
                                    <div style="z-index: 1; position: absolute; left: 50%; top: 50%; width: 100%; transform: translate(0px, 0px);">
                                        <div style="position: absolute; left: 0px; top: 0px; z-index: 100; width: 100%;">
                                            <div style="position: absolute; left: 0px; top: 0px; z-index: 0;">
                                                <div style="position: absolute; z-index: 1; transform: matrix(1, 0, 0, 1, -79, -221);">
                                        ...
                                        <div style="position: absolute; left: 0px; top: 0px; z-index: 0;">
                                            <div style="position: absolute; z-index: 1; transform: matrix(1, 0, 0, 1, -79, -221);">
                                                <div style="position: absolute; left: 0px; top: 256px; width: 256px; height: 256px;">
                                                    <img draggable="false" alt="" aria-hidden="true" src="https://maps.google.com/maps/vt?pb=!1m5!1m4!1i15!2i26096!3i15396!4i256!2m3!1e0!2sm!3i434138752!3m9!2sen-US!3sUS!5e18!12m1!1e68!12m3!1e37!2m1!1ssmartmaps!4e0!5m1!5f2!23i1301875&amp;key=AIzaSyAKUuXw8s42trJRIlpJkkc9204AfUxlhcI&amp;token=61983" style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;"></div>
                                                <div style="position: absolute; left: 256px; top: 256px; width: 256px; height: 256px;">
                                                    <img draggable="false" alt="" aria-hidden="true" src="https://maps.google.com/maps/vt?pb=!1m5!1m4!1i15!2i26097!3i15396!4i256!2m3!1e0!2sm!3i434138752!3m9!2sen-US!3sUS!5e18!12m1!1e68!12m3!1e37!2m1!1ssmartmaps!4e0!5m1!5f2!23i1301875&amp;key=AIzaSyAKUuXw8s42trJRIlpJkkc9204AfUxlhcI&amp;token=51602" style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;"></div>
                                                <div style="position: absolute; left: -256px; top: 256px; width: 256px; height: 256px;">
                                                    <img draggable="false" alt="" aria-hidden="true" src="https://maps.google.com/maps/vt?pb=!1m5!1m4!1i15!2i26095!3i15396!4i256!2m3!1e0!2sm!3i434138752!3m9!2sen-US!3sUS!5e18!12m1!1e68!12m3!1e37!2m1!1ssmartmaps!4e0!5m1!5f2!23i1301875&amp;key=AIzaSyAKUuXw8s42trJRIlpJkkc9204AfUxlhcI&amp;token=72364" style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;"></div>
                                                <div style="position: absolute; left: -256px; top: 0px; width: 256px; height: 256px;">
                                                    <img draggable="false" alt="" aria-hidden="true" src="https://maps.google.com/maps/vt?pb=!1m5!1m4!1i15!2i26095!3i15395!4i256!2m3!1e0!2sm!3i434138752!3m9!2sen-US!3sUS!5e18!12m1!1e68!12m3!1e37!2m1!1ssmartmaps!4e0!5m1!5f2!23i1301875&amp;key=AIzaSyAKUuXw8s42trJRIlpJkkc9204AfUxlhcI&amp;token=124336" style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;"></div>
                                                <div style="position: absolute; left: 0px; top: 0px; width: 256px; height: 256px;">
                                                    <img draggable="false" alt="" aria-hidden="true" src="https://maps.google.com/maps/vt?pb=!1m5!1m4!1i15!2i26096!3i15395!4i256!2m3!1e0!2sm!3i434138752!3m9!2sen-US!3sUS!5e18!12m1!1e68!12m3!1e37!2m1!1ssmartmaps!4e0!5m1!5f2!23i1301875&amp;key=AIzaSyAKUuXw8s42trJRIlpJkkc9204AfUxlhcI&amp;token=113955" style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;"></div>
                                                <div style="position: absolute; left: 256px; top: 0px; width: 256px; height: 256px;">
                                                    <img draggable="false" alt="" aria-hidden="true" src="https://maps.google.com/maps/vt?pb=!1m5!1m4!1i15!2i26097!3i15395!4i256!2m3!1e0!2sm!3i434138752!3m9!2sen-US!3sUS!5e18!12m1!1e68!12m3!1e37!2m1!1ssmartmaps!4e0!5m1!5f2!23i1301875&amp;key=AIzaSyAKUuXw8s42trJRIlpJkkc9204AfUxlhcI&amp;token=103574" style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;"></div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div style="z-index: 4; position: absolute; left: 50%; top: 50%; width: 100%; transform: translate(0px, 0px);">
                                            ...
                                            <div style="position: absolute; left: 0px; top: 0px; z-index: 106; width: 100%;">
                                                <div style="width: 27px; height: 43px; overflow: hidden; position: absolute; opacity: 0; left: -14px; top: -43px; z-index: 0;">
                                                    <img alt="" src="https://maps.gstatic.com/mapfiles/api-3/images/spotlight-poi2_hdpi.png" draggable="false" usemap="#gmimap0" style="position: absolute; left: 0px; top: 0px; width: 27px; height: 43px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                                            ...
                                            <div style="position: absolute; left: 0px; top: 0px; z-index: 107; width: 100%;">
                                                <div style="cursor: default; position: absolute; width: 320px; height: 37px; left: -160px; top: -104px; z-index: -104;">
                                                    <div style="position: absolute; left: 0px; top: 0px;">
                                                        <div style="width: 0px; height: 0px; border-right: 10px solid transparent; border-left: 10px solid transparent; border-top: 24px solid rgba(0, 0, 0, 0.1); position: absolute; left: 150px; top: 37px;"></div>
                                                        <div style="position: absolute; left: 0px; top: 0px; background-color: rgba(0, 0, 0, 0.2); border-radius: 2px; box-shadow: rgba(0, 0, 0, 0.3) 0px 1px 4px -1px; width: 320px; height: 37px;"></div>
                                                        <div style="border-top-width: 24px; position: absolute; left: 150px; top: 34px;">
                                                        ...
                                                        <div style="position: absolute; left: 1px; top: 1px; border-radius: 2px; background-color: rgb(255, 255, 255); width: 318px; height: 35px;"></div>
                                                    </div>
                                                    <div class="gm-style-iw" style="top: 9px; position: absolute; left: 15px; width: 290px;">
                                                        <div style="display: inline-block; overflow: auto; max-height: 654px; max-width: 654px;">
                                                            <div style="overflow: auto;"><span id="address"><b>Địa chỉ:</b> 254A Nguyễn Đình Chiểu - Q3 - TpHCM</span></div>
                                                        </div>
                                                    </div>
                                                    <div style="width: 13px; height: 13px; overflow: hidden; position: absolute; opacity: 0.7; right: 12px; top: 10px; z-index: 10000; cursor: pointer;">
                                ...
                                <div style="margin-left: 5px; margin-right: 5px; z-index: 1000000; position: absolute; left: 0px; bottom: 0px;"><a target="_blank" rel="noopener" href="https://maps.google.com/maps?ll=10.791633,106.702628&amp;z=15&amp;t=m&amp;hl=en-US&amp;gl=US&amp;mapclient=apiv3" title="Click to see this area on Google Maps" style="position: static; overflow: visible; float: none; display: inline;">
                                ...
                                <div style="background-color: white; padding: 15px 21px; border: 1px solid rgb(171, 171, 171); font-family: Roboto, Arial, sans-serif; color: rgb(34, 34, 34); box-sizing: border-box; box-shadow: rgba(0, 0, 0, 0.2) 0px 4px 16px; z-index: 10000002; display: none; width: 300px; height: 180px; position: absolute; left: 113px; top: 85px;">
                                ...
                                <div draggable="false" class="gm-style-cc" style="user-select: none; height: 14px; line-height: 14px; position: absolute; right: 0px; bottom: 0px;">
                                    ...
                                    <div style="position: relative; padding-right: 6px; padding-left: 6px; font-family: Roboto, Arial, sans-serif; font-size: 10px; color: rgb(68, 68, 68); white-space: nowrap; direction: ltr; text-align: right; vertical-align: middle; display: inline-block;"><a target="_blank" rel="noopener" title="Report errors in the road map or imagery to Google" href="https://www.google.com/maps/@10.791633,106.702628,15z/data=!10m1!1e1!12b1?source=apiv3&amp;rapsrc=apiv3" style="font-family: Roboto, Arial, sans-serif; font-size: 10px; color: rgb(68, 68, 68); text-decoration: none; position: relative;">Report a map error</a></div>
                                </div>
                                        ...
                                        <div style="background-color: white; z-index: -1; padding: 2px; border-bottom-left-radius: 2px; border-bottom-right-radius: 2px; box-shadow: rgba(0, 0, 0, 0.3) 0px 1px 4px -1px; position: absolute; left: 0px; top: 40px; text-align: left; display: none;">
                                            <div draggable="false" title="Show street map with terrain" style="color: rgb(0, 0, 0); font-family: Roboto, Arial, sans-serif; user-select: none; font-size: 18px; background-color: rgb(255, 255, 255); padding: 6px 8px 6px 6px; direction: ltr; text-align: left; white-space: nowrap;"><span role="checkbox" style="box-sizing: border-box; position: relative; line-height: 0; font-size: 0px; margin: 0px 5px 0px 0px; display: inline-block; background-color: rgb(255, 255, 255); border: 1px solid rgb(198, 198, 198); border-radius: 1px; width: 13px; height: 13px; vertical-align: middle;">
                                                <div style="position: absolute; left: 1px; top: -2px; width: 13px; height: 11px; overflow: hidden; display: none;">
                                                    <img alt="" src="https://maps.gstatic.com/mapfiles/mv/imgs8.png" draggable="false" style="position: absolute; left: -52px; top: -44px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none; width: 68px; height: 67px;">
                                                </div>
                                            </span>
