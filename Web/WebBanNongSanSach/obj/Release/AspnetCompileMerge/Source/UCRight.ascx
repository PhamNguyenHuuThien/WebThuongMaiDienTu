    ...
    <div class="dv_content_leftsp">
        ...
        <ul class="tags_links" style="inl">
            ...
            <asp:DataList ID="ListTags" runat="server" RepeatLayout="Flow" RepeatDirection="Horizontal" ShowFooter="False" ShowHeader="False">
                ...
                <li>
                    <asp:HyperLink ID="HyperLink1" CssClass="tags_links " runat="server" Text='<%# Eval("TenTag") %>' NavigateUrl='<%# "/DanhSachSanpham.aspx?LinkTag="+Eval("linkTag") %>'>HyperLink</asp:HyperLink>
                </li>
                </ItemTemplate>
            </asp:DataList>
            </ul>
