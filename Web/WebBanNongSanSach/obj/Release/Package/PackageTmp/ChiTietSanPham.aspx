<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ChiTietSanPham.aspx.cs" Inherits="WebBanNongSanSach.ChiTietSanPham" %>
...
<asp:Label runat="server" CssClass='gia_thanhtien gia_thanhtien_cus1' Text='<%# Eval("GiaBan","{0:0,0} <sup>đ</sup>") +"/"+ Eval("DonViTinh") %>'></asp:Label>
              ...
              <asp:DropDownList ID="dlSoluong" CssClass="form-control" runat="server"></asp:DropDownList>
...
<script>(function(d, s, id) {
  ...
  fjs.parentNode.insertBefore(js, fjs);
                                    ...
                                    <div class="fb-like" data-href="<%=HttpContext.Current.Request.Url.AbsoluteUri %>" data-layout="button_count" data-action="like" data-size="small" data-show-faces="true" data-share="false"></div>
                                </li>
